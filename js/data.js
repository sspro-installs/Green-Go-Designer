...
// --- REMOVED CONSTANTS ---
// const LABOR_RATE = 0.20; // This is now loaded from pricing.json
// const PROGRAMMING_SETUP_RATE = 0.05; // This is now loaded from pricing.json
// const SUPPORT_MATERIALS_RATE = 0.10; // This is now loaded from pricing.json
...
function computeFromProducts(finalProductsMap) {
    ...
    // --- CALCULATIONS NOW USE GLOBAL VARIABLES LOADED FROM PRICING.JSON ---
    const labor = equipmentCost * LABOR_RATE;
    const programming = equipmentCost * PROGRAMMING_SETUP_RATE;
    const supportMaterials = equipmentCost * SUPPORT_MATERIALS_RATE; // This now uses the global variable
